...
public class ObjectReferenceFieldHandler extends CommonHandler implements Fieldhandler  {
    ...
    public FieldDescribe createField(ExcelDataVO excelDataVO) {
        ...
        ObjectReferenceFieldDescribe field = new ObjectReferenceFieldDescribe();
    ...
    @Data
    @NoArgsConstructor
    class ObjectReferenceFieldDescribe extends FieldDescribe{
