...
public class MyCircularDeque641 {
    ...
    public static void main(String[] args) {
        ...
        myCircularDeque641.insertLast(1);
        myCircularDeque641.insertLast(2);
        myCircularDeque641.insertFront(3);
        boolean b = myCircularDeque641.insertFront(4);

        int rear = myCircularDeque641.getRear();

        boolean full = myCircularDeque641.isFull();
        myCircularDeque641.deleteLast();
        myCircularDeque641.getFront();
